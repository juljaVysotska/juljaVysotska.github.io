        ...
        $(window).on('resize', function () {
            if($(window).width() >= 768){
                $(".graph .agregat .table-responsive").removeClass("table-striped");
                $(".graph .params-table .table-params").removeClass("table-striped");
            }else{
                $(".graph .agregat .table-responsive").addClass("table-striped");
                $(".graph .params-table .table-params").addClass("table-striped");
        ...
        if($(window).width() <= 1200){
            $(".graph .control").click(function () {
                $(".graph .control").removeClass('active-pane');
                $(this).addClass('active-pane');
                

                if($(this).hasClass("params-pane")){
                    
                    $('.graph .params-table').animate({
                        width: '100%'
                    });

                    $('.graph .coming-in,.graph .coming-out').animate({
                        width: '0'
                    });

                    

                    console.log("params pane")
                }

                if($(this).hasClass('coming-in-pane')){
                    $('.graph .coming-in').animate({
                        width: '100%'
                    });

                    $('.graph .params-table,.graph .coming-out').animate({
                        width: '0'
                    });
                ...
                if($(this).hasClass('coming-out-pane')){
                    

                    $('.graph .coming-out').animate({
                        width: '100%'
                    });

                    $('.graph .params-table,.graph .coming-in').animate({
                        width: '0'
                    });
